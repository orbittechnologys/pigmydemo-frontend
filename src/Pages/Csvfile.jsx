...
const Csvfile = () => {
  ...
  const Csvfile = (e) => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/csv/${AgentId}/${selectedDate}`
      )
      .then((response) => {
  ...
  const Csvfile_For_Type = (e) => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/customerTransactionCSV/${phone}/${accountType}/${startDate}/${endDate}`
      )
      .then((response) => {
        // Extract CSV data from the response
        console.log(response);
  ...
  const Csvfile_All = (e) => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/customerTransactionCsvForAllAccountTypes/${phone}/${startDate}/${endDate}`
      )
      .then((response) => {
        // Extract CSV data from the response
        console.log(response);
  ...
  const Csvfile_AllTransaction = (e) => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/generateAllCustomersCsvForAllAccountTypes/${selectstartdate}/${selectenddate}`
      )
      .then((response) => {
        // Extract CSV data from the response
        console.log(response);
      ...
      <div className="row">
        ...
        >
          <div>
            ...
            <div>{loading2 && <Loader width={30} height={30} />}</div>
            <div>
              <input
                onClick={Csvfile_AllTransaction}
                style={{ backgroundColor: "#010042" }}
                className="btn btn-dark mt-3"
                type="submit"
                value="Download"

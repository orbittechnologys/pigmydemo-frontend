...
const AllAccTransaction = () => {
  ...
  const getAllCommission = () => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/getAllAccountTypeTransactions/${currentpage}/${recordsperpages}/${selectedvalue}`
      )
      .then((response) => {
  ...
  //     setLoading(true);
  //     await axios.get(`https://pigmy.uur.co.in:8443/transaction/getAllAccountTypeTransactions/${phone}/${startDate}/${endDate}`)
  //     .then((response) => {
  //         console.log(response);
  ...
  const searchCustomers = () => {
    ...
    console.log(phone, startDate, endDate);
    axios
      .get("https://pigmy.uur.co.in:8443/transaction/getApiAllAccountType", {
        params: {
          endDate: endDate,
          phone: phone,
          startDate: startDate,
              ...
              <table className="table table-hover table-bordered table-striped ">
                ...
                >
                  <tr style={{ fontSize: "20px" }}>
                    ...
                    <th>Type</th>
                    <th>Cur Balance</th>
                    {user.role === "SUPERADMIN" && <th>Action</th>}
                  </tr>
                </thead>
                <tbody>
                        ...
                        <tr style={{ fontSize: "20px" }}>
                          ...
                          <td style={{ fontSize: "20px" }}>
                            {user.role === "SUPERADMIN" && (
                              <Link
                                to={`/editAllaccount1.2.3.00/${val.id}`}
...
export default AllAccTransaction;

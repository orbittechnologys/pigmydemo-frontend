            ...
            >
              <div className="m-3">
                <img
                  width={140}
                  height={150}
                  src={editdata.agentAadharCardImage}
                  alt="not found"
                />
              </div>
              <div className="m-3">
                <img
                  width={140}
                  height={150}
                  src={editdata.agentPanCardImage}
                  alt="not found"
                />
              </div>
              <div className="m-3">
                <img
                  width={140}
                  height={150}
                  src={editdata.agentProfileImage}
                  alt="not found"
                />
              </div>
            </div>
                ...
                >
                  <tr className="me-3">
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        seteditdata({ ...editdata, agentName: e.target.value })
                      }
                    />
                  </tr>

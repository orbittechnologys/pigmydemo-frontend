        ...
        <div className="container-fluid">
          <div className="row">
            ...
            <div style={{ display: "flex", justifyContent: "center" }}>
              ...
              >
                <img
                  style={{ maxWidth: 180, maxHeight: 180, objectFit: "fit" }}
                  src={editdata.customerAadharImage}
                  alt="not found"
                />
              </div>
              ...
              >
                <img
                  ...
                  src={editdata.customerProfilePic}
                  alt="not found"
                />
              </div>
            </div>
            ...
            <div className="col-lg-12 p-5">
              <form onSubmit={editform}>
                ...
                >
                  <tr className="me-3">
                    <th style={{ width: "100vw", padding: "2%  0 1% 0" }}>
                      Aadhaar Number
                    </th>
                    <input
                      type="text"
                  ...
                  <tr className="me-3">
                    ...
                    <input
                      ...
                      className="form-control"
                      onChange={(e) =>
                        seteditdata({ ...editdata, agentId: e.target.value })
                      }
                    />
                  </tr>
                </div>
                ...
                >
                  <tr className="me-2">
                    <th style={{ width: "80vw", padding: "1% 0 2% 0" }}>
                      Customer Aadhaar Card Image
                    </th>
                    <input
                      type="file"
                      name="agentAadharCardImage"
                      accept=".png, .jpg, .jpeg"
                      className="form-control"

...
const Customer = () => {
  ...
  const getAllCustomer = () => {
    axios
      .get(
        `https://orbitpay.uur.co.in//customer/getAllCustomers/${currentpage}/${recordsperpages}/${field}`,
      )
      .then((response) => {
  ...
  //     axios
  //         .get(`https://orbitpay.uur.co.in/transaction/getCustomersWithNoTransactionsToday/${'Pigmy'}/${localdate}`)
  //         .then((response) => {
  ...
  const searchCustomers = () => {
    axios
      .get(`https://orbitpay.uur.co.in/customer/query/${searchQuery}`)
      .then((response) => {
        console.log(response.data);
  ...
  const downloadCsv = async () => {
    try {
      const res = await axios.get(
        "https://orbitpay.uur.co.in/transaction/generateCsvForAllCustomers",
        { responseType: "blob" },
      );

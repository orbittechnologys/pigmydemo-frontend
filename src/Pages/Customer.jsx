...
const Customer = () => {
  ...
  const getAllCustomer = () => {
    axios
      .get(
        `https://unioncooperativesocietylimited.in:8443//customer/getAllCustomers/${currentpage}/${recordsperpages}/${field}`
      )
      .then((response) => {
  ...
  //     axios
  //         .get(`https://unioncooperativesocietylimited.in:8443/transaction/getCustomersWithNoTransactionsToday/${'Pigmy'}/${localdate}`)
  //         .then((response) => {
  ...
  const searchCustomers = () => {
    axios
      .get(
        `https://unioncooperativesocietylimited.in:8443/customer/query/${searchQuery}`
      )
      .then((response) => {
        console.log(response.data);
  ...
  const downloadCsv = async () => {
    try {
      const res = await axios.get(
        "https://unioncooperativesocietylimited.in:8443/transaction/generateCsvForAllCustomers",
        { responseType: "blob" }
      );

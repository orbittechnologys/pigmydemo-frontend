...
const AllLoan = () => {
  ...
  const getAllCommission = () => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/getAllLoan/${currentpage}/${recordsperpages}/${selectedvalue}`
      )
      .then((response) => {
  ...
  const searchCustomers = () => {
    ...
    axios
      .get(
        `https://pigmy.uur.co.in:8443/transaction/getAllLoanTransactions/${phone}/${startDate}/${endDate}`
      )
      .then((response) => {
